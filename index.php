...
<?php get_header();?>
    ...
    <section class="container d-flex align-items-center justify-content-center my-5">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <a href="<?php echo get_template_directory_uri();?>/menu.html" class="btn btn-transparent custom-btn" style="background-color: #CC9D2F;">Our Venue </a>
    ...
    <section class="container-fluid full-screen-image position-relative">
      ...
      <div class="image-content position-absolute top-50 start-50 translate-middle text-center">
        ...
        <a href="<?php echo get_template_directory_uri();?>/menu.html" class="btn btn-transparent custom-btn" style="background-color: #CC9D2F;">Our Menu</a>
      </div>
    </section>
   <?php get_footer();?>
